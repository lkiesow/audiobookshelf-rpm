...
%changelog
* Thu Sep 17 2026 Lars Kiesow <lkiesow@uos.de> - 2.36.1-1
- Update to 2.36.1

* Tue Jul 28 2026 Lars Kiesow <lkiesow@uos.de> - 2.36.0-1
- Update to 2.36.0

* Fri May 29 2026 Lars Kiesow <lkiesow@uos.de> - 2.35.1-1
- Update to 2.35.1

* Mon May 18 2026 Lars Kiesow <lkiesow@uos.de> - 2.35.0-1
- Update to 2.35.0

* Tue Apr 28 2026 Lars Kiesow <lkiesow@uos.de> - 2.34.0-1
- Update to 2.34.0

* Mon Apr 20 2026 Lars Kiesow <lkiesow@uos.de> - 2.33.2-1
- Update to 2.33.2

* Fri Mar 20 2026 Lars Kiesow <lkiesow@uos.de> - 2.33.1-1
- Update to 2.33.1

* Fri Mar 13 2026 Lars Kiesow <lkiesow@uos.de> - 2.33.0-1
- Update to 2.33.0

* Wed Dec 24 2025 Lars Kiesow <lkiesow@uos.de> - 2.32.1-1
- Update to 2.32.1

* Mon Dec 22 2025 Lars Kiesow <lkiesow@uos.de> - 2.32.0-1
- Update to 2.32.0

* Tue Dec 02 2025 Lars Kiesow <lkiesow@uos.de> - 2.31.0-1
- Update to 2.31.0

* Thu Oct 09 2025 Lars Kiesow <lkiesow@uos.de> - 2.30.0-1
- Update to 2.30.0

* Tue Aug 26 2025 Lars Kiesow <lkiesow@uos.de> - 2.29.0-1
- Update to 2.29.0

* Mon Aug 11 2025 Lars Kiesow <lkiesow@uos.de> - 2.28.0-1
- Update to 2.28.0
...
* Tue Jul 22 2025 Lars Kiesow <lkiesow@uos.de> - 2.26.2-1
- Update to 2.26.2

* Thu Jul 17 2025 Lars Kiesow <lkiesow@uos.de> - 2.26.1-1
- Update to 2.26.1

* Sun Jul 13 2025 Lars Kiesow <lkiesow@uos.de> - 2.26.0-1
- Update to 2.26.0

* Sun Jun 15 2025 Lars Kiesow <lkiesow@uos.de> - 2.25.1-1
- Update to 2.25.1

* Mon Jun 02 2025 Lars Kiesow <lkiesow@uos.de> - 2.24.0-1
- Update to 2.24.0

* Sat May 17 2025 Lars Kiesow <lkiesow@uos.de> - 2.23.0-1
- Update to 2.23.0

* Thu May 15 2025 Lars Kiesow <lkiesow@uos.de> - 2.22.0-1
- Update to 2.22.0

* Mon Apr 28 2025 Lars Kiesow <lkiesow@uos.de> - 2.21.0-1
- Update to 2.21.0

* Tue Mar 18 2025 Lars Kiesow <lkiesow@uos.de> - 2.20.0-1
- Update to 2.20.0

* Mon Feb 24 2025 Lars Kiesow <lkiesow@uos.de> - 2.19.5-1
- Update to 2.19.5

* Thu Feb 20 2025 Lars Kiesow <lkiesow@uos.de> - 2.19.4-1
- Update to 2.19.4

* Mon Feb 17 2025 Lars Kiesow <lkiesow@uos.de> - 2.19.3-1
- Update to 2.19.3

* Thu Feb 13 2025 Lars Kiesow <lkiesow@uos.de> - 2.19.2-1
- Update to 2.19.2

* Wed Feb 12 2025 Lars Kiesow <lkiesow@uos.de> - 2.19.1-1
- Update to 2.19.1

* Mon Feb 03 2025 Lars Kiesow <lkiesow@uos.de> - 2.19.0-1
- Update to 2.19.0
